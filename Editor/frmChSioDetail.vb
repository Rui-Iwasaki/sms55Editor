...
#Region "画面イベント"
    ...
    Private Sub cmdBinary_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdBinary.Click
        ...
        Try
            ...
            ''画面設定を構造体に格納
            Call mSetStructure(shtNum, udtVdr, mudtSioCh(cmbPort.SelectedIndex))

            ''構造体データをバイト配列に変換
            Call mConvTypeToByteArray(udtVdr, bytArray)

            ''バイナリエディタ画面を開く
            If frmChSioBinary.gShow(cmbPort.Text, bytArray, mudtVdr(cmbPort.SelectedIndex).bytSetData, Me) = 1 Then
    ...
    Private Sub btnBinaryExt_Click(sender As System.Object, e As System.EventArgs) Handles btnBinaryExt.Click
        ...
        If chkSioExt.Checked = True Then
            'バイナリエディタ画面を開く
            If frmChSioBinaryext.gShow(cmbPort.Text, mudtSioExt(cmbPort.SelectedIndex).bytSioExtRec, Me) = 1 Then
                ''初期化中フラグ
                mblnInitFlg = True
...
#Region "内部関数"
    ...
    Private Sub mSetCommTypeCombo(ByVal intValueCommType1 As Integer, ByVal intValueCommType2 As Integer)

        Try

            ''CommType1
            If mSetComboAdd(intValueCommType1, cmbCommType1, gEnmComboType.ctChSioDetailcmbCommType1) = 0 Then

                '================================================
                ''CommType1の項目がリストに存在した場合
                '================================================
                Call mSetComboAdd(intValueCommType2, cmbCommType2, gEnmComboType.ctChSioDetailcmbCommType2, intValueCommType1)
                cmbCommType2.SelectedValue = intValueCommType2
                If cmbCommType2.Text = "" Then cmbCommType2.SelectedIndex = 0
            ...
            Else
                ...
                '================================================
                Call mSetComboAdd(intValueCommType2, cmbCommType2, gEnmComboType.ctChSioDetailcmbCommType2, 99)
                cmbCommType2.SelectedIndex = 0
