...
#Region "画面イベント"
    ...
    ' 機能説明  : 画面表示初期処理を行う
    '--------------------------------------------------------------------
    Private Sub frmChSioList_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub cmdDetails_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDetails.Click
        ...
        Try
            ...
            ''SIO設定詳細画面表示
            If frmChSioDetail.gShow(grdSIO.SelectedCells(0).RowIndex, mudtSetChSioNew.shtNum, mudtSetChSioNew.udtVdr, mudtSetChSioChNew, mudtSetChSioExtNew, Me) = 1 Then
    ...
    Private Sub mInitialDataGrid()
        ...
        Try
            ...
            With grdSIO
                ...
                .Columns(2).HeaderText = "COMMType1"
                .Columns(2).Width = 240

                .Columns(3).HeaderText = "COMMType2"
                .Columns(3).Width = 240
        ...
        Try
            ...
            For i As Integer = 0 To grdSIO.Rows.Count - 1
                ...
                With udtSet.udtVdr(i)
                    ...
                    grdSIO.Item(2, i).Value = IIf(strRtn = "", Hex(.shtCommType1), strRtn)

                    ''通信種別２名称
                    strRtn = gGetComboItemName(.shtCommType2, gEnmComboType.ctChSioDetailcmbCommType2, .shtCommType1, False)
                    grdSIO.Item(3, i).Value = IIf(strRtn = "", Hex(.shtCommType2), strRtn)
