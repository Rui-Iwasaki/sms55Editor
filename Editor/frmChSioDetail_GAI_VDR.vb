Public Class frmChSioDetail_GAI_VDR
...
#Region "画面イベント"
    ...
    ' 機能説明  : 画面表示初期処理を行う
    '--------------------------------------------------------------------
    Private Sub frmChSioDetail_GAI_VDR_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub mSetDisplay(ByVal udtVdr As gTypSetChSioVdr)
        Try
            With udtVdr
                ...
                chkON.Checked = IIf(.bytSetData(4) = 1, True, False)    'Time Stamp ON OFF
            End With
