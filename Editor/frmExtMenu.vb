...
#Region "画面イベント"
    ...
    ' 機能説明  : 画面表示初期処理を行う
    '--------------------------------------------------------------------
    Private Sub frmExtMenu_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    '--------------------------------------------------------------------
    Private Sub frmExtMenu_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
    ...
    '--------------------------------------------------------------------
    Private Sub frmExtMenu_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
...
#Region "画面遷移"
    ...
    Private Sub cmdMenu2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdMenu2.Click

        Try

            frmExtEccEeengineerCall.gShow(Me)
    ...
    Private Sub cmdMenu3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdMenu3.Click

        Try

            frmExtEccPatrolManCall.gShow(Me)
    ...
    Private Sub cmdMenu4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdMenu4.Click

        Try

            frmExtEccDeadmanAlarm.gShow(Me)
    ...
    Private Sub cmdMenu10_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdMenu10.Click

        Try

            frmExtPnlSystem.gShow(Me)
    ...
    Private Sub cmdMenu11_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdMenu11.Click

        Try

            frmExtPnlAlarmGroup.gShow(Me)
    ...
    Private Sub cmdMenu15_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdMenu15.Click
...
#Region "内部関数"
    ...
    Private Sub mSetDisplay(ByVal udtSet As gTypSetExtCommon)
        ...
        Try
            ...
            ''コンバイン設定
            optCombine.Checked = IIf(gBitCheck(udtSet.shtCombineSet, 0), True, False)
            optStandard.Checked = IIf(gBitCheck(udtSet.shtCombineSet, 0), False, True)
    ...
    Private Sub mSetStructure(ByRef udtSet As gTypSetExtCommon)
        ...
        Try
            ...
            ''コンバイン設定
            udtSet.shtCombineSet = IIf(optCombine.Checked, 1, 0)
    ...
    Private Sub mCopyStructure(ByVal udtSource As gTypSetExtCommon, _
        ...
        Try
            ...
            udtTarget.shtCombineSet = udtSource.shtCombineSet
    ...
    Private Function mChkStructureEquals(ByVal udt1 As gTypSetExtCommon, _
        ...
        Try
            ...
            If udt1.shtCombineSet <> udt2.shtCombineSet Then Return False
